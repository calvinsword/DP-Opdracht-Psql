...
//
//        //tostring testen vanuit database gekregen Reiziger
//        Reiziger r1 = rdao.findById(77);
//        System.out.println("\ntostring testen vanuit database gekregen Reiziger");
...
//        //GET + TOSTRING
//        Reiziger r1 = rdao.findById(77);
//        System.out.println("\ntostring testen vanuit database gekregen Reiziger met OVChipkaart");
//        System.out.println(r1.toString());
//
//        //DELETE
...
//
    public static void testProductDAO(ReizigerDAOPsql rdao,OVChipkaartDAOsql odao, ProductDAO pdao) throws Exception {
        ...
        //TOSTRING
        System.out.println("\n OVChipkaart met Product");
        System.out.println(producttestov.toString());
        System.out.println("\n Get OV by Reiziger");
        Reiziger r1 = rdao.findById(77);
        System.out.println(r1.toString());
